...
public class ProcessoSeletivo {
    ...
    static void EntradoEmContato(String candidato) {
        ...
        do {
            ...
            if (continuarTentando)
                ...
                System.out.println("Contato Realzado com Sucesso");
    ...
    static void imprimirSelecionados() {
        ...
        System.out.println("Imprimindo a lista de candidatos infromando o indice do elemendo ");
